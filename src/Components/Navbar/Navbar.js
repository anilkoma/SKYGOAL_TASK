...
const Navbar = () => {
    return (
        <div>
            <nav class="navbar bg-white navbar-expand-lg bg-light px-5 my-2 shadow-sm">
                <a class="navbar-brand red fs-3 dsi" href='#' >DSI</a>
                    ...
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0 text-sm">
                        ...
                        <li class="nav-item dropdown ms-2">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="#">Our branches</a></li>
                        ...
                        <li class="nav-item dropdown ms-2">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><hr class="dropdown-divider" /></li>
                                <li><a class="dropdown-item" href="#">Out Team</a></li>
